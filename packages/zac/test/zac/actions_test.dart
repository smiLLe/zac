    ...
    testWidgets('simple', (tester) async {
      ...
      await testMap(
        ...
        page(
          ...
          actions: [
            <String, dynamic>{
              converterKey: FlutterNavigator.unionValuePush,
              'route': {
                ...
                'child': page(
                      ...
                      'route': {
                        ...
                        'child': page(
                          ...
                          actions: [
                            <String, dynamic>{
                              converterKey:
                                  FlutterNavigator.unionValuePushReplacement,
                              'route': {
                                converterKey: 'f:1:MaterialPageRoute',
                                'child': page(
                                  number: 4,
                                  ...
                                  backActions: [
                                    <String, dynamic>{
                                      converterKey:
                                          FlutterNavigator.unionValuePop,
                                    }
                                  ],
                                ),
                              },
                          ...
                          backActions: [
                            <String, dynamic>{
                              converterKey: FlutterNavigator.unionValueMaybePop,
                            }
                          ],
                        ),
                      }
                  ...
                  backActions: [
                    <String, dynamic>{
                      converterKey: FlutterNavigator.unionValuePop,
                    }
                  ],
                ),
              }
