...
void main() {
  ...
  testWidgets('SizedBox.expand()', (tester) async {
    await testMap(
      tester,
      <String, dynamic>{
        '_converter': FlutterSizedBox.unionValueExpand,
        'key': KeysModel.getValueKey('FINDME'),
        'child': ChildModel.getSizedBox(key: 'child'),
      },
    );
  ...
  testWidgets('SizedBox.shrink()', (tester) async {
    await testMap(
      tester,
      <String, dynamic>{
        '_converter': FlutterSizedBox.unionValueShrink,
        'key': KeysModel.getValueKey('FINDME'),
        'child': ChildModel.getSizedBox(key: 'child'),
      },
    );
  ...
  testWidgets('SizedBox.fromSize()', (tester) async {
    await testMap(
      tester,
      <String, dynamic>{
        '_converter': FlutterSizedBox.unionValueFromSize,
        'key': KeysModel.getValueKey('FINDME'),
        'size': {
          '_converter': 'f:1:Size',
          'width': 10,
  ...
  testWidgets('SizedBox.square()', (tester) async {
    await testMap(
      tester,
      <String, dynamic>{
        '_converter': FlutterSizedBox.unionValueSquare,
        'key': KeysModel.getValueKey('FINDME'),
        'dimension': 22,
        'child': ChildModel.getSizedBox(key: 'child'),
      },
