...
export class DartCompleterVoid extends ZacConverter {
}
...
export class DartCompleterVoidBuilder extends ZacConverter {
    static new() {
...
export class GlobalKeyNavigatorState extends ZacConverter {
    static new(data) {
        return new GlobalKeyNavigatorState(Object.assign({ converter: 'f:1:GlobalKey<NavigatorState>' }, data));
    }
}
export class GlobalKeyScaffoldMessengerState extends ZacConverter {
    static new(data) {
        return new GlobalKeyScaffoldMessengerState(Object.assign({ converter: 'f:1:GlobalKey<ScaffoldMessengerState>' }, data));
    }
}
...
export class ZacCompleterActions extends ZacConverter {
    static completeVoid(data) {
        return new ZacCompleterActions(Object.assign({ converter: 'z:1:CompleterAction.completeVoid' }, data));
    }
}
