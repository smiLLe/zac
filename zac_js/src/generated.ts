...
export class Color extends ZacConverter {
  static fromARGB(data: {a: DartInt,
r: DartInt,
g: DartInt,
b: DartInt}) {
  return new Color({
...
static fromRGBO(data: {r: DartInt,
g: DartInt,
b: DartInt,
...
export class Offset extends ZacConverter {
  static new(data: {dx: ZacValue<DartDouble>,
...
static fromDirection(data: {direction: ZacValue<DartDouble>,
...
static elliptical(data: {x: ZacValue<DartDouble>,
...
export class TextHeightBehavior extends ZacConverter {
  static new(data: {applyHeightToFirstAscent?: ZacValue<boolean>,
...
static fromLTRB(data: {left: ZacValue<DartDouble>,
...
static fromLTWH(data: {left: ZacValue<DartDouble>,
top: ZacValue<DartDouble>,
width: ZacValue<DartDouble>,
height: ZacValue<DartDouble>}) {
  return new Rect({
...
export class Size extends ZacConverter {
  static new(data: {width: ZacValue<DartDouble>,
height: ZacValue<DartDouble>}) {
  return new Size({
    converter: 'f:1:Size',
    ...data
...
export class StrutStyle extends ZacConverter {
  static new(data: {fontFamily?: ZacValue<string>,
...
export class TextStyle extends ZacConverter {
  static new(data: {inherit?: ZacValue<boolean>,
color?: Color,
...
export class Alignment extends ZacConverter implements AlignmentGeometry {
  static new(data: {x: ZacValue<DartDouble>,
y: ZacValue<DartDouble>}) {
...
export class AlignmentDirectional extends ZacConverter implements AlignmentGeometry {
  static new(data: {start: ZacValue<DartDouble>,
y: ZacValue<DartDouble>}) {
...
export class BorderDirectional extends ZacConverter implements BoxBorder {
  static new(data: {top?: BorderSide,
start?: BorderSide,
bottom?: BorderSide,
end?: BorderSide}) {
...
static horizontal(data: {left?: Radius,
right?: Radius}) {
  return new BorderRadius({
...
static symmetric(data: {vertical?: ZacValue<DartDouble>,
...
static only(data: {left?: ZacValue<DartDouble>,
top?: ZacValue<DartDouble>,
right?: ZacValue<DartDouble>,
bottom?: ZacValue<DartDouble>}) {
  return new EdgeInsets({
...
static only(data: {start?: ZacValue<DartDouble>,
top?: ZacValue<DartDouble>,
...
export class BoxConstraints extends ZacConverter {
  static new(data: {minWidth?: ZacValue<DartDouble>,
...
static expand(data: {width?: ZacValue<DartDouble>,
height?: ZacValue<DartDouble>}) {
  return new BoxConstraints({
...
static tightFor(data: {width?: ZacValue<DartDouble>,
height?: ZacValue<DartDouble>}) {
  return new BoxConstraints({
...
static tightForFinite(data: {width?: ZacValue<DartDouble>,
height?: ZacValue<DartDouble>}) {
  return new BoxConstraints({
...
export class SystemUiOverlayStyle extends ZacConverter {
  static new(data: {systemNavigationBarColor?: Color,
...
static isolateString(data: {key?: Key,
...
export class ZacExecuteActionsBuilder extends ZacConverter implements Widget {
  static once(data: {actions: ZacActions,
child?: Widget}) {
...
static listen(data: {actions: ZacActions,
family: ZacTypes,
child?: Widget}) {
  return new ZacExecuteActionsBuilder({
...
export class Icon extends ZacConverter implements Widget {
  static new(data: {icon: IconData | null,
key?: Key,
...
export class IconData extends ZacConverter {
  static new(data: {codePoint: ZacValue<DartInt>,
fontFamily?: ZacValue<string>,
...
export class Image extends ZacConverter implements Widget {
  static network(data: {src: ZacValue<string>,
key?: Key,
...
static asset(data: {name: ZacValue<string>,
key?: Key,
semanticLabel?: ZacValue<string>,
excludeFromSemantics?: ZacValue<boolean>,
scale?: ZacValue<DartDouble>,
...
static directional(data: {key?: Key,
textDirection: TextDirection,
...
static alertDialog(data: {key?: Key,
title?: Widget,
content?: Widget,
actions?: ZacValueList<Widget>,
...
static simpleDialog(data: {key?: Key,
title?: Widget,
children?: ZacValueList<Widget>,
titlePadding?: EdgeInsetsGeometry,
titleTextStyle?: TextStyle,
...
static simpleDialogOption(data: {key?: Key,
child?: Widget,
onPressed?: ZacActions,
padding?: EdgeInsets}) {
  return new Dialogs({
...
export class DialogActions extends ZacConverter implements ZacAction {
  static showDialog(data: {child: Widget,
...
static showBottomSheet(data: {child: Widget,
backgroundColor?: Color,
elevation?: ZacValue<DartDouble>,
shape?: ShapeBorder,
clipBehavior?: Clip,
...
static pushNamed(data: {routeName: ZacValue<string>,
arguments?: ZacTypes,
navigatorState?: NavigatorState}) {
  return new NavigatorActions({
...
static pop(data: {actions?: ZacActions,
navigatorState?: NavigatorState}) {
  return new NavigatorActions({
...
static maybePop(data: {actions?: ZacActions,
navigatorState?: NavigatorState}) {
  return new NavigatorActions({
...
static pushReplacement(data: {route: Route,
result?: ZacActions,
navigatorState?: NavigatorState}) {
  return new NavigatorActions({
...
static pushReplacementNamed(data: {routeName: ZacValue<string>,
arguments?: ZacTypes,
navigatorState?: NavigatorState,
result?: ZacActions}) {
  return new NavigatorActions({
...
export class RouteSettings extends ZacConverter {
  static new(data: {name?: ZacValue<string>,
arguments?: ZacTypes}) {
...
export class SliverChildDelegate extends ZacConverter {
  static list(data: {children: ZacValueList<Widget>,
addAutomaticKeepAlives?: ZacValue<boolean>,
addRepaintBoundaries?: ZacValue<boolean>,
addSemanticIndexes?: ZacValue<boolean>,
...
static listFixed(data: {children: ZacValueList<Widget>,
addAutomaticKeepAlives?: ZacValue<boolean>,
addRepaintBoundaries?: ZacValue<boolean>,
addSemanticIndexes?: ZacValue<boolean>,
semanticIndexOffset?: ZacValue<DartInt>}) {
...
export class SliverGridDelegate extends ZacConverter {
  static withFixedCrossAxisCount(data: {crossAxisCount: DartInt,
...
static withMaxCrossAxisExtent(data: {maxCrossAxisExtent: ZacValue<DartDouble>,
mainAxisSpacing?: ZacValue<DartDouble>,
crossAxisSpacing?: ZacValue<DartDouble>,
childAspectRatio?: ZacValue<DartDouble>,
mainAxisExtent?: ZacValue<DartDouble>}) {
...
export class Text extends ZacConverter implements Widget {
  static new(data: {data: ZacValue<string>,
key?: Key,
style?: TextStyle,
strutStyle?: StrutStyle,
textAlign?: TextAlign,
...
export class ZacFlutterGlobalKeyNavigatorStateProvider extends ZacConverter implements Widget {
  static new(data: {family: ZacTypes,
child: Widget,
debugLabel?: ZacValue<string>}) {
...
export class ZacFlutterNavigatorActions extends ZacConverter implements ZacAction {
  static popUntilRouteName(data: {routeName: ZacValue<string>,
navigatorState?: NavigatorState}) {
...
export class RouteFactorySingleRoute extends ZacConverter implements RouteFactory {
  static new(data: {routeConfig: RouteFactoryRouteConfig,
...
export class RouteFactoryFromRoutes extends ZacConverter implements RouteFactory {
  static new(data: {routes: Record<string, RouteFactoryRouteConfig>,
provideArgsNamePrefix?: string}) {
...
static replaceWith(data: {family: ZacTypes,
...
export class UnderlineInputBorder extends ZacConverter implements InputBorder {
  static new(data: {borderSide?: BorderSide,
...
export class ZacStateMachineActions extends ZacConverter implements ZacAction {
  static send(data: {family: ZacTypes,
...
static trySend(data: {family: ZacTypes,
event: ZacValue<string>}) {
  return new ZacStateMachineActions({
...
static mapper(data: {keyTransformer?: ZacTransformers,
...
static replaceAll(data: {from: ZacValue<string>,
...
export class ZacValueActions extends ZacConverter implements ZacAction {
  static asPayload(data: {value: ZacValueRead<ZacTypes | null>,
actions: ZacActions}) {
...
export class ZacTemplateExpressionsTransformer extends ZacConverter implements ZacTransformer {
  static new(data: {expression: string,
...
export class TsTest extends ZacConverter {
  static new(data: {reqButOpt: DartInt | null,
