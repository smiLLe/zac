...
Map<String, Convert> allConverters = const {
  ...
  ObjectTransformer.unionValueIsBool: ObjectTransformer.fromJson,
  ObjectTransformer.unionValueIsString: ObjectTransformer.fromJson,
  ObjectTransformer.unionValueIsDouble: ObjectTransformer.fromJson,
  ObjectTransformer.unionValueIsInt: ObjectTransformer.fromJson,
  ObjectTransformer.unionValueIsFlutterWidget: ObjectTransformer.fromJson,
  ObjectTransformer.unionValueIsNull: ObjectTransformer.fromJson,
