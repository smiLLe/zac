...
void addZacBuilders(ZacRegistry registry) {
  registry.addAll(const <String, Object>{
    ...
    'f:1:BoxHeightStyle.includeLineSpacingBottom':
        FlutterBoxHeightStyle.fromJson,
    'f:1:BoxHeightStyle.includeLineSpacingMiddle':
        FlutterBoxHeightStyle.fromJson,
    ...
    'f:1:FloatingActionButton': FlutterFloatingActionButton.fromJson,
    'f:1:FloatingActionButton.extended': FlutterFloatingActionButton.fromJson,
    ...
    'f:1:PanAxis.aligned': FlutterPanAxis.fromJson,
    'f:1:PanAxis.free': FlutterPanAxis.fromJson,
    'f:1:PanAxis.horizontal': FlutterPanAxis.fromJson,
    'f:1:PanAxis.vertical': FlutterPanAxis.fromJson,
    ...
    'f:1:ScrollController': FlutterScrollController.fromJson,
    ...
    'z:1:Action:If': ZacControlFlowAction.fromJson,
    'z:1:Build.fromBuilder': ZacBuild.fromJson,
    'z:1:Build.fromBuilderMap': ZacBuild.fromJson,
    ...
    'z:1:List<ZacAction>': ZacListOfActions.fromJson,
    'z:1:List<ZacTransform>': ZacListOfTransformers.fromJson,
    'z:1:Map<String, Widget>': ZacMapOfWidgets.fromJson,
    ...
    'z:1:Transformer:int.decr': IntTransformer.fromJson,
    'z:1:Transformer:int.incr': IntTransformer.fromJson,
