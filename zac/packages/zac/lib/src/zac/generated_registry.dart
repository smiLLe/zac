...
registry..register('f:1:AlertDialog', FlutterDialogs.fromJson)
...
..register('f:1:AlignmentDirectional.bottomCenter', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.bottomEnd', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.bottomStart', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.center', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.centerEnd', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.centerStart', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.topCenter', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.topEnd', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlignmentDirectional.topStart', FlutterAlignmentDirectional.fromJson)
..register('f:1:AlwaysScrollableScrollPhysics', FlutterScrollPhysics.fromJson)
...
..register('f:1:BoxConstraints.tightForFinite', FlutterBoxConstraints.fromJson)
...
..register('f:1:BoxHeightStyle.includeLineSpacingBottom', FlutterBoxHeightStyle.fromJson)
..register('f:1:BoxHeightStyle.includeLineSpacingMiddle', FlutterBoxHeightStyle.fromJson)
..register('f:1:BoxHeightStyle.includeLineSpacingTop', FlutterBoxHeightStyle.fromJson)
...
..register('f:1:CircularProgressIndicator', FlutterProgressIndicator.fromJson)
...
..register('f:1:CrossAxisAlignment.baseline', FlutterCrossAxisAlignment.fromJson)
..register('f:1:CrossAxisAlignment.center', FlutterCrossAxisAlignment.fromJson)
..register('f:1:CrossAxisAlignment.end', FlutterCrossAxisAlignment.fromJson)
..register('f:1:CrossAxisAlignment.start', FlutterCrossAxisAlignment.fromJson)
..register('f:1:CrossAxisAlignment.stretch', FlutterCrossAxisAlignment.fromJson)
..register('f:1:CustomScrollView', FlutterCustomScrollView.fromJson)
..register('f:1:DecoratedBox', FlutterDecoratedBox.fromJson)
..register('f:1:DecorationPosition.background', FlutterDecorationPosition.fromJson)
..register('f:1:DecorationPosition.foreground', FlutterDecorationPosition.fromJson)
...
..register('f:1:EdgeInsetsDirectional.all', FlutterEdgeInsetsDirectional.fromJson)
..register('f:1:EdgeInsetsDirectional.only', FlutterEdgeInsetsDirectional.fromJson)
...
..register('f:1:FloatingActionButton.extended', FlutterFloatingActionButton.fromJson)
..register('f:1:FloatingActionButton.large', FlutterFloatingActionButton.fromJson)
..register('f:1:FloatingActionButton.small', FlutterFloatingActionButton.fromJson)
..register('f:1:FontFeature', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.alternative', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.alternativeFractions', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.caseSensitiveForms', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.characterVariant', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.contextualAlternates', FlutterFontFeature.fromJson)
...
..register('f:1:FontFeature.historicalLigatures', FlutterFontFeature.fromJson)
...
..register('f:1:FontFeature.proportionalFigures', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.randomize', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.scientificInferiors', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.slashedZero', FlutterFontFeature.fromJson)
..register('f:1:FontFeature.stylisticAlternates', FlutterFontFeature.fromJson)
...
..register('f:1:FractionalTranslation', FlutterFractionalTranslation.fromJson)
...
..register('f:1:HitTestBehavior.deferToChild', FlutterHitTestBehavior.fromJson)
..register('f:1:HitTestBehavior.opaque', FlutterHitTestBehavior.fromJson)
..register('f:1:HitTestBehavior.translucent', FlutterHitTestBehavior.fromJson)
...
..register('f:1:MainAxisAlignment.center', FlutterMainAxisAlignment.fromJson)
..register('f:1:MainAxisAlignment.end', FlutterMainAxisAlignment.fromJson)
..register('f:1:MainAxisAlignment.spaceAround', FlutterMainAxisAlignment.fromJson)
..register('f:1:MainAxisAlignment.spaceBetween', FlutterMainAxisAlignment.fromJson)
..register('f:1:MainAxisAlignment.spaceEvenly', FlutterMainAxisAlignment.fromJson)
...
..register('f:1:Navigator.pushReplacement', FlutterNavigatorActions.fromJson)
..register('f:1:Navigator.pushReplacementNamed', FlutterNavigatorActions.fromJson)
...
..register('f:1:RefreshIndicatorTriggerMode.anywhere', FlutterRefreshIndicatorTriggerMode.fromJson)
..register('f:1:RefreshIndicatorTriggerMode.onEdge', FlutterRefreshIndicatorTriggerMode.fromJson)
..register('f:1:RotatedBox', FlutterRotatedBox.fromJson)
..register('f:1:RoundedRectangleBorder', FlutterRoundedRectangleBorder.fromJson)
...
..register('f:1:ScaffoldMessenger.hideCurrentMaterialBanner', FlutterScaffoldMessenger.fromJson)
..register('f:1:ScaffoldMessenger.hideCurrentSnackBar', FlutterScaffoldMessenger.fromJson)
..register('f:1:ScaffoldMessenger.removeCurrentMaterialBanner', FlutterScaffoldMessenger.fromJson)
..register('f:1:ScaffoldMessenger.removeCurrentSnackBar', FlutterScaffoldMessenger.fromJson)
..register('f:1:ScaffoldMessenger.showMaterialBanner', FlutterScaffoldMessenger.fromJson)
..register('f:1:ScaffoldMessenger.showSnackBar', FlutterScaffoldMessenger.fromJson)
..register('f:1:ScrollViewKeyboardDismissBehavior.manual', FlutterScrollViewKeyboardDismissBehavior.fromJson)
..register('f:1:ScrollViewKeyboardDismissBehavior.onDrag', FlutterScrollViewKeyboardDismissBehavior.fromJson)
...
..register('f:1:SingleChildScrollView', FlutterSingleChildScrollView.fromJson)
...
..register('f:1:SliverChildListDelegate', FlutterSliverChildDelegate.fromJson)
..register('f:1:SliverChildListDelegate.fixed', FlutterSliverChildDelegate.fromJson)
..register('f:1:SliverGrid', FlutterSliverGrid.fromJson)
..register('f:1:SliverGridDelegateWithFixedCrossAxisCount', FlutterSliverGridDelegate.fromJson)
..register('f:1:SliverGridDelegateWithMaxCrossAxisExtent', FlutterSliverGridDelegate.fromJson)
...
..register('f:1:SnackBarBehavior.floating', FlutterSnackBarBehavior.fromJson)
...
..register('f:1:TextAlignVertical.bottom', FlutterTextAlignVertical.fromJson)
..register('f:1:TextAlignVertical.center', FlutterTextAlignVertical.fromJson)
...
..register('f:1:TextCapitalization.characters', FlutterTextCapitalization.fromJson)
..register('f:1:TextCapitalization.none', FlutterTextCapitalization.fromJson)
..register('f:1:TextCapitalization.sentences', FlutterTextCapitalization.fromJson)
..register('f:1:TextCapitalization.words', FlutterTextCapitalization.fromJson)
...
..register('f:1:TextDecorationStyle.dashed', FlutterTextDecorationStyle.fromJson)
..register('f:1:TextDecorationStyle.dotted', FlutterTextDecorationStyle.fromJson)
..register('f:1:TextDecorationStyle.double', FlutterTextDecorationStyle.fromJson)
..register('f:1:TextDecorationStyle.solid', FlutterTextDecorationStyle.fromJson)
..register('f:1:TextDecorationStyle.wavy', FlutterTextDecorationStyle.fromJson)
...
..register('f:1:TextInputAction.continueAction', FlutterTextInputAction.fromJson)
..register('f:1:TextInputAction.done', FlutterTextInputAction.fromJson)
..register('f:1:TextInputAction.emergencyCall', FlutterTextInputAction.fromJson)
...
..register('f:1:TextInputAction.unspecified', FlutterTextInputAction.fromJson)
...
..register('f:1:TextInputType.visiblePassword', FlutterTextInputType.fromJson)
..register('f:1:TextLeadingDistribution.even', FlutterTextLeadingDistribution.fromJson)
..register('f:1:TextLeadingDistribution.proportional', FlutterTextLeadingDistribution.fromJson)
...
..register('f:1:WrapCrossAlignment.center', FlutterWrapCrossAlignment.fromJson)
..register('f:1:WrapCrossAlignment.end', FlutterWrapCrossAlignment.fromJson)
..register('f:1:WrapCrossAlignment.start', FlutterWrapCrossAlignment.fromJson)
...
..register('z:1:GlobalKey<NavigatorState>.provide', FlutterGlobalKeyNavigatorStateProvider.fromJson)
..register('z:1:GlobalKey<ScaffoldMessengerState>.provide', FlutterGlobalKeyScaffoldMessengerStateProvider.fromJson)
..register('z:1:List<Widget>.provide', SharedValueProviderBuilder.fromJson)
..register('z:1:Map<String, Widget>.provide', SharedValueProviderBuilder.fromJson)
..register('z:1:Navigator.popUntilRouteName', FlutterNavigatorActions.fromJson)
...
..register('z:1:StateMachine.provide', ZacStateMachineProviderBuilder.fromJson)
..register('z:1:StateMachine:Action.send', ZacStateMachineActions.fromJson)
..register('z:1:StateMachine:Action.trySend', ZacStateMachineActions.fromJson)
..register('z:1:StateMachine:BuildState', ZacStateMachineBuildStateBuilder.fromJson)
...
..register('z:1:ZacBuilder<Object>.provide', SharedValueProviderBuilder.fromJson)
...
..registerTransformer('z:1:StateMachine:Transformer.pickContext', ZacStateMachineTransformer.fromJson)
..registerTransformer('z:1:StateMachine:Transformer.pickState', ZacStateMachineTransformer.fromJson)
..registerTransformer('z:1:Transformer:Bool.negate', BoolTransformer.fromJson)
..registerTransformer('z:1:Transformer:Converter', ConvertTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.contains', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.elementAt', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.first', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.isEmpty', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.isNotEmpty', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.join', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.last', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.length', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.map', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.single', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.skip', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.take', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.toList', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.toSet', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Iterable.toString', IterableTransformer.fromJson)
..registerTransformer('z:1:Transformer:Json.decode', JsonTransformer.fromJson)
..registerTransformer('z:1:Transformer:Json.encode', JsonTransformer.fromJson)
..registerTransformer('z:1:Transformer:List.add', ListTransformer.fromJson)
..registerTransformer('z:1:Transformer:List.reversed', ListTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map.containsKey', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map.containsValue', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map.entries', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map.isEmpty', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map.isNotEmpty', MapTransformer.fromJson)
...
..registerTransformer('z:1:Transformer:Map.setValueForKey', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map.values', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map<Object, Object>.from', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map<String, Object>.from', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map<String, Object?>.from', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Map[key]', MapTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.equals', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.equalsSharedValue', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.hashCode', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.isBool', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.isDouble', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.isInt', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.isList', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.isMap', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.isNull', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.isString', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.runtimeType', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:Object.toString', ObjectTransformer.fromJson)
..registerTransformer('z:1:Transformer:String.isEmpty', StringTransformer.fromJson)
..registerTransformer('z:1:Transformer:String.isNotEmpty', StringTransformer.fromJson)
..registerTransformer('z:1:Transformer:String.length', StringTransformer.fromJson)
..registerTransformer('z:1:Transformer:String.replaceAll', StringTransformer.fromJson)
..registerTransformer('z:1:Transformer:String.split', StringTransformer.fromJson)
...
..registerTransformer('z:1:Transformer:int.tryParse', IntTransformer.fromJson)
...
..registerTransformer('z:1:Transformer:num.ceilToDouble', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.floor', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.floorToDouble', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.isFinite', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.isInfinite', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.isNan', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.isNegative', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.round', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.roundToDouble', NumTransformer.fromJson)
..registerTransformer('z:1:Transformer:num.toDouble', NumTransformer.fromJson)
