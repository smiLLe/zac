...
void addZacBuilders(ZacRegistry registry) {
  registry
    ...
    ..register('f:1:PanAxis.aligned', FlutterPanAxis.fromJson)
    ..register('f:1:PanAxis.free', FlutterPanAxis.fromJson)
    ..register('f:1:PanAxis.horizontal', FlutterPanAxis.fromJson)
    ..register('f:1:PanAxis.vertical', FlutterPanAxis.fromJson)
