...
Map<String, Object Function(Map<String, dynamic> data)> zacConverter = const {
  ...
  'z:1:DateTime.transformable': ZacDateTime.fromJson,
  ...
  'z:1:String.transformable': ZacString.fromJson,
