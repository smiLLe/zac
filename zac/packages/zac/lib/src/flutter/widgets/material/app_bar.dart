  ...
  AppBar buildWidget(ZacContext zacContext) {
    ...
    return AppBar(
      ...
      automaticallyImplyLeading:
          automaticallyImplyLeading?.getValueOrNull(zacContext) ?? true,
      ...
      primary: primary?.getValueOrNull(zacContext) ?? true,
      centerTitle: centerTitle?.getValueOrNull(zacContext),
      excludeHeaderSemantics:
          excludeHeaderSemantics?.getValueOrNull(zacContext) ?? false,
      titleSpacing: titleSpacing?.getValueOrNull(zacContext),
      toolbarOpacity: toolbarOpacity?.getValueOrNull(zacContext) ?? 1.0,
      bottomOpacity: bottomOpacity?.getValueOrNull(zacContext) ?? 1.0,
      toolbarHeight: toolbarHeight?.getValueOrNull(zacContext),
      leadingWidth: leadingWidth?.getValueOrNull(zacContext),
