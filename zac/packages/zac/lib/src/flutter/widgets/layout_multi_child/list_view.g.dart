...
_$_FlutterListView _$$_FlutterListViewFromJson(Map<String, dynamic> json) =>
    _$_FlutterListView(
      ...
      physics: json['physics'] == null
          ? null
          : ZacBuilder<ScrollPhysics?>.fromJson(json['physics'] as Object),
      ...
      itemExtent: json['itemExtent'] == null
          ? null
          : ZacBuilder<double?>.fromJson(json['itemExtent'] as Object),
      prototypeItem: json['prototypeItem'] == null
          ? null
          : ZacBuilder<Widget?>.fromJson(json['prototypeItem'] as Object),
