...
class FlutterInputDecoration with _$FlutterInputDecoration {
  ...
  InputDecoration build(ZacContext zacContext) {
    return InputDecoration(
      ...
      isCollapsed: isCollapsed?.getValueOrNull(zacContext) ?? false,
      isDense: isDense?.getValueOrNull(zacContext),
      ...
      filled: filled?.getValueOrNull(zacContext),
      ...
      alignLabelWithHint: alignLabelWithHint?.getValueOrNull(zacContext),
