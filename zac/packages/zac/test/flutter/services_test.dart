  ...
  test('FlutterTextInputType', () {
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.datetime'}).build,
      (matcher) => matcher.having(
          (p0) => p0, 'TextInputType.datetime', equals(TextInputType.datetime)),
    );
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.emailAddress'}).build,
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.multiline'}).build,
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.name'}).build,
      (matcher) => matcher.having(
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.number'}).build,
      (matcher) => matcher.having(
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.phone'}).build,
      (matcher) => matcher.having(
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
              <String, dynamic>{'builder': 'f:1:TextInputType.streetAddress'})
          .build,
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.text'}).build,
      (matcher) => matcher.having(
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputType.url'}).build,
      (matcher) => matcher.having(
    ...
    fakeBuild<TextInputType>(
      FlutterTextInputType.fromJson(
              <String, dynamic>{'builder': 'f:1:TextInputType.visiblePassword'})
          .build,
  ...
  test('FlutterTextInputAction', () {
    ...
    fakeBuild<TextInputAction>(
      FlutterTextInputAction.fromJson(
          <String, dynamic>{'builder': 'f:1:TextInputAction.done'}).build,
      (matcher) => matcher.having(
          (p0) => p0, 'TextInputAction.done', equals(TextInputAction.done)),
    );
    fakeBuild<TextInputAction>(
      FlutterTextInputAction.fromJson(
              <String, dynamic>{'builder': 'f:1:TextInputAction.emergencyCall'})
          .build,
  ...
  test('FlutterTextCapitalization', () {
    fakeBuild<TextCapitalization>(
      FlutterTextCapitalization.fromJson(
              <String, dynamic>{'builder': 'f:1:TextCapitalization.characters'})
          .build,
    ...
    fakeBuild<TextCapitalization>(
      FlutterTextCapitalization.fromJson(
          <String, dynamic>{'builder': 'f:1:TextCapitalization.none'}).build,
    ...
    fakeBuild<TextCapitalization>(
      FlutterTextCapitalization.fromJson(
              <String, dynamic>{'builder': 'f:1:TextCapitalization.sentences'})
          .build,
    ...
    fakeBuild<TextCapitalization>(
      FlutterTextCapitalization.fromJson(
          <String, dynamic>{'builder': 'f:1:TextCapitalization.words'}).build,
  ...
  test('FlutterSmartDashesType', () {
    fakeBuild<SmartDashesType>(
      FlutterSmartDashesType.fromJson(
          <String, dynamic>{'builder': 'f:1:SmartDashesType.disabled'}).build,
      (matcher) => matcher.having((p0) => p0, 'SmartDashesType.disabled',
          equals(SmartDashesType.disabled)),
    );
    fakeBuild<SmartDashesType>(
      FlutterSmartDashesType.fromJson(
          <String, dynamic>{'builder': 'f:1:SmartDashesType.enabled'}).build,
      (matcher) => matcher.having((p0) => p0, 'SmartDashesType.disabled',
  ...
  test('FlutterSmartQuotesType', () {
    fakeBuild<SmartQuotesType>(
      FlutterSmartQuotesType.fromJson(
          <String, dynamic>{'builder': 'f:1:SmartQuotesType.disabled'}).build,
      (matcher) => matcher.having((p0) => p0, 'SmartQuotesType.disabled',
          equals(SmartQuotesType.disabled)),
    );
    fakeBuild<SmartQuotesType>(
      FlutterSmartQuotesType.fromJson(
          <String, dynamic>{'builder': 'f:1:SmartQuotesType.enabled'}).build,
